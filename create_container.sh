...
rm -rf /tmp/lima/test_container.sif
...
apptainer build /tmp/lima/test_container.sif amd64_ubu.def 
...
apptainer shell --writable --cleanenv --fakeroot /tmp/lima/test_container.sif